function enable(){
	...
	document.getElementById("survivalButton").disabled = false;
	document.getElementById("singlePlayerEasyButton").disabled = false;
	document.getElementById("singlePlayerHardButton").disabled = false;
	document.getElementById("twoPlayerInvisibleButton").disabled = false;
	document.getElementById("fourPlayerEliminiationButton").disabled = false;
}
function disable(){
	document.getElementById("endlessButton").disabled = true;
	document.getElementById("twoPlayerButton").disabled = true;
	document.getElementById("survivalButton").disabled = true;
	document.getElementById("singlePlayerEasyButton").disabled = true;
	document.getElementById("singlePlayerHardButton").disabled = true;
	document.getElementById("twoPlayerInvisibleButton").disabled = true;
	document.getElementById("fourPlayerEliminiationButton").disabled = true;
}

function twoPlayerInstructions(){
	disable();
