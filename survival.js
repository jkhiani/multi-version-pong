function survivalInstructions(){
	...
	function changeBg(){
		canvas.style.background = 'url("survivalInstructions.jpg")';
		x++;
...
function survival(){
	...
	function drawLives(){
			...
			context.fillText("Lives:"+userLives, 10, 150);
	...
	function drawScore(){
			...
			context.fillText("Score:"+userScore, 10, canvas.height/2);
			context.fillStyle = "#000000";
			context.fill();
			context.closePath();
	}
